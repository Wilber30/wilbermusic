<div class="text-center py-10 bg-off-white">
  <div class="container sm:mx-auto">
    <div class="flex justify-center">
      <div class="w-3/4 lg:w-1/3 border-dark-grey/50 border-b-4 border-solid">
        <h1 id="latest-videos" class="font-Special mb-7 text-white font-outline-2 text-4xl lg:text-5xl">
          Latest Videos
        </h1>
      </div>
    </div>
